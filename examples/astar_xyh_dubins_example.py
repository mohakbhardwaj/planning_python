...
lattice_params = dict()
lattice_params['x_lims']          = x_lims                             # Used to calculate number of cells in lattice (should ideally be consistent with env_params['x_lims'])
lattice_params['y_lims']          = y_lims                             # Used to calculate number of cells in lattice (should ideally be consistent with env_params['y_lims'])
...
lattice_params['connectivity']    = 'dubins_turn_90'                   #Lattice connectivity (can be four or eight connected for xylattice)
